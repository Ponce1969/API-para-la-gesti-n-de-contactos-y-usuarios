...
class Settings(BaseSettings):
    ...
    # ======================
    DEBUG: bool = False
    SECRET_KEY: str = 'django-insecure-9f8h7g6f5d4s3a2s1d0a9s8d7f6g5h4j3k2l1q0w9e8r7t6y5'
    ...
    def validate_cors_origins(cls, v: Union[str, List[str]]) -> List[str]:
        if isinstance(v, str) and not v.startswith('['):
            ...
            return v
        raise ValueError('CORS_ORIGINS debe ser una lista o una cadena separada por comas')
    
    # Tiempo de espera para operaciones asíncronas (segundos)
    ASYNC_TIMEOUT: int = 30
    
    # Configuración de la base de datos
    DATABASE_URL: PostgresDsn = 'postgresql+asyncpg://postgres:postgres@db:5432/app_statica_db'
    ...
    JWT_SECRET_KEY: str = 'django-insecure-9f8h7g6f5d4s3a2s1d0a9s8d7f6g5h4j3k2l1q0w9e8r7t6y5'
    JWT_REFRESH_SECRET_KEY: str = 'django-insecure-9f8h7g6f5d4s3a2s1d0a9s8d7f6g5h4j3k2l1q0w9e8r7t6y6'
    ...
    SMTP_TLS: bool = Field(
        True,
        env='APP_SMTP_TLS',
        description='Habilita TLS para conexiones SMTP'
    )
