...
class Contact(Base):
    ...
    company: Mapped[Optional[str]] = mapped_column(
        String(255), 
        nullable=True,
        comment='Empresa u organización del contacto'
    )
    ...
    address: Mapped[Optional[str]] = mapped_column(
        Text, 
        nullable=True,
        comment='Dirección física completa del contacto'
    )
    notes: Mapped[Optional[str]] = mapped_column(
        Text, 
        nullable=True,
        comment='Notas adicionales sobre el contacto'
    )
...
class ContactGroup(Base):
    ...
    name: Mapped[str] = mapped_column(
        String(100), 
        nullable=False,
        comment='Nombre del grupo de contactos'
    )
    description: Mapped[Optional[str]] = mapped_column(
        Text, 
        nullable=True,
        comment='Descripción del grupo de contactos'
    )
...
contact_group_members = Table(
    ...
    Column('notes', Text, nullable=True, comment='Notas sobre la pertenencia a este grupo'),
