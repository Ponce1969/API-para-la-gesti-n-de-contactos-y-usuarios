...
class UserBase(BaseModel):
    ...
    is_superuser: bool = Field(default=False, description="Indica si el usuario es superusuario")
    is_verified: bool = Field(default=False, description="Indica si el correo del usuario ha sido verificado")
...
class UserUpdate(BaseModel):
    ...
    password: Optional[str] = Field(None, min_length=8, max_length=100, description="Nueva contraseña")
    is_active: Optional[bool] = Field(None, description="Indica si el usuario está activo")
    is_verified: Optional[bool] = Field(None, description="Indica si el correo ha sido verificado")
